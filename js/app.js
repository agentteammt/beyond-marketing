;(function(){
/* Lädt ein scroll-gescrubbtes Video als Blob-URL, sobald es in die Nähe des
   Viewports kommt. Grund: ohne echtes Range-Serving meldet der Browser
   seekable=[0,0] und currentTime-Zuweisungen werden auf 0 geklemmt — die
   Scroll-Animation friert ein. Eine Blob-Quelle ist immer voll spulbar. */
function __blobifyScrubVideo(wrap, v) {
if (!wrap || !v || v.__blobified) return;
const load = () => {
if (v.__blobified) return; v.__blobified = true;
const src = v.getAttribute("src"); if (!src || src.indexOf("blob:") === 0) return;
fetch(src).then(r => r.ok ? r.blob() : Promise.reject()).then(b => {
const t = v.currentTime || 0;
v.src = URL.createObjectURL(b);
const restore = () => { try { v.currentTime = t; } catch (e) {} v.removeEventListener("loadedmetadata", restore); };
v.addEventListener("loadedmetadata", restore);
}).catch(() => { v.__blobified = false; });
};
if (!("IntersectionObserver" in window)) { load(); return; }
const io = new IntersectionObserver(es => { for (const e of es) if (e.isIntersecting) { io.disconnect(); load(); return; } }, { rootMargin: "160% 0%" });
io.observe(wrap);
}
const CONTENT = {
brand: "team::mt",
...
function beyondSlug(s) { return String(s || "").toLowerCase().replace(/ä/g, "ae").replace(/ö/g, "oe").replace(/ü/g, "ue").replace(/ß/g, "ss").replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, ""); }
...
src: "assets/logo-wordmark.jpg", alt: "team::mt – KI Marketing Agentur für B2B", width: 462, height: 76, style: { height: 21, width: "auto", display: "block", mixBlendMode: "multiply" }
})), h("nav", {
className: "topnav",
...
}, label); }).concat([h("a", { key: "blog", href: "/blog", className: "beyond-track-nav-link", "data-beyond-event": "Beyond_Nav_Link_blog", style: { transition: "color .2s", color: "var(--ink-dim)", fontWeight: 500 }, onMouseEnter: e => e.currentTarget.style.color = "var(--accent)", onMouseLeave: e => e.currentTarget.style.color = "var(--ink-dim)" }, "Blog")])), h("a", {
...
return h("a", { key: "blog", href: "/blog", className: "beyond-track-nav-link", "data-beyond-event": "Beyond_Nav_Link_blog", onClick: () => setMenuOpen(false),
style: { display: "flex", alignItems: "baseline", gap: 16, fontFamily: "Poppins", fontWeight: 700, fontSize: "clamp(34px,11vw,56px)", letterSpacing: "-.02em", lineHeight: 1.06, color: "var(--ink)", textDecoration: "none", padding: "14px 0", borderBottom: "1px solid var(--line)", opacity: menuOpen ? 1 : 0, transform: menuOpen ? "translateY(0)" : "translateY(30px)", transition: "opacity .5s cubic-bezier(.2,.8,.2,1) " + dl + "s, transform .62s cubic-bezier(.2,.8,.2,1) " + dl + "s" },
onMouseEnter: e => e.currentTarget.style.color = "var(--accent)",
onMouseLeave: e => e.currentTarget.style.color = "var(--ink)" },
h("span", { "aria-hidden": "true", style: { fontFamily: '"EB Garamond", Georgia, serif', fontStyle: "italic", fontWeight: 500, fontSize: "clamp(13px,3.4vw,17px)", color: "var(--accent)", flex: "none" } }, "04"),
h("span", null, "Blog"));
})()])),
(function () {
const dl = menuOpen ? (0.14 + 4 * 0.08) : 0;
...
const heroImage = tweaks.heroStyle === "Mond" ? "assets/hero-moon-1600.webp" : "assets/hero-overalls.webp";
...
const head = sec.querySelector("h2") || sec.querySelector(".tw-line") || sec.querySelector("p");
...
}, "KI Marketing Agentur · B2B"), intro.active ? React.createElement(Typewriter, {
...
style: { color: "#db0830" }
}, "Beyond "), React.createElement("span", {
style: { color: "#0e1b2e" }
}, "Marketing."), CONTENT.claimAccent ? React.createElement(React.Fragment, null, React.createElement("br", null), React.createElement("span", {
style: {
color: "var(--accent)",
textShadow: "0 0 calc(50px*var(--glow)) color-mix(in srgb,var(--accent) 55%, transparent)"
}
}, CONTENT.claimAccent)) : null), React.createElement("p", {
style: {
...Object.assign({
...
}, CONTENT.claimSub), React.createElement("div", {
style: Object.assign({
display: "flex",
gap: 14,
flexWrap: "wrap",
...
}), React.createElement(ScanFrame, null), sr.playing && React.createElement("span", {
className: "scan-reveal-line play",
key: sr.run,
"aria-hidden": "true"
}), stamp && React.createElement("div", {
style: {
position: "absolute",
zIndex: 4,
right: "7%",
...
}, React.createElement(StatusStempel, {
label: stamp.label,
sub: stamp.sub,
color: stamp.color
})), React.createElement("div", {
...
return React.createElement(CheckPanel, {
id: "checks",
...
img: "assets/viz-red-1.webp",
alt: "GEO-Analyse der KI Marketing Agentur team::mt – Mechaniker prüft die KI-Sichtbarkeit einer B2B-Website am Monitor",
...
img: "assets/viz-red-2.webp",
alt: "LinkedIn-Check der KI Marketing Agentur – Mechaniker justiert mit dem Schraubenschlüssel den B2B-Kanal LinkedIn",
...
num: "// 03"
}, "KI zum Anfassen"), React.createElement("h2", {
style: {
...
}, "Weitere ", React.createElement("span", {
style: {
color: "var(--accent)"
}
}, "KI-Werkstatt-Impulse"), ".")), React.createElement(Reveal, {
delay: 100
}, React.createElement("div", {
style: {
display: "grid",
...
name: "sign",
size: 15
}), " Ergebnis zum Mitnehmen"), React.createElement("h3", {
style: {
fontSize: "clamp(22px,2.6vw,30px)",
marginBottom: 6
}
}, "Ehrliche und konkret Tipps und Tricks f\xFCr Ihren KI Alltag, jetzt anmelden."), React.createElement("p", {
style: {
color: "var(--ink-dim)",
fontSize: 15,
margin: 0
...
}, "// Mission Control"), React.createElement("h2", {
style: {
...
}, "team::mt"), " \u2014 das Team hinter der Werkstatt"), React.createElement("p", {
className: "lead",
style: {
color: "var(--ink-dim)",
fontSize: 17,
...
}, "Wir sind eine Marketing-Agentur aus Rosenheim & K\u00f6ln, die Marketing-Abteilungen KI-f\xE4hig macht \u2014 von Sichtbarkeit bis Automatisierung. Die KI-Werkstatt ist unser Stand, an dem wir genau das live zeigen."), React.createElement("div", {
className: "display",
style: {
...
}, "Beyond Marketing."), React.createElement("div", {
style: {
display: "flex",
gap: 14,
flexWrap: "wrap",
...
}, "team-mt.de ", React.createElement(Icon, {
name: "arrow",
size: 16
}))))), React.createElement(HazardEdge, {
thin: true,
...
src: "assets/viz-red-3.webp",
alt: "Beyond Marketing im Aufbau – 'Work in Progress'-Tafel der KI Marketing Agentur team::mt",
style: {
position: "absolute",
inset: 0,
width: "100%",
...
name: "sign",
size: 16
}), " Baustelle im Orbit"), React.createElement("h2", {
style: {
...
}, "KI ist kein Werkzeug f\xFCr sp\xE4ter.", React.createElement("br", null), React.createElement("span", {
style: {
color: "var(--accent)"
}
}, "Es liegt schon auf Ihrer Werkbank.")), React.createElement("p", {
className: "lead",
style: {
color: "var(--ink-dim)",
fontSize: 17,
...
}, React.Children.map(children, (ch, i) => React.createElement("div", {
key: i,
style: {
flex: "0 0 100vw",
width: "100vw",
...
}, "01 / " + ("0" + count).slice(-2)), React.createElement("div", {
style: {
display: "flex",
gap: 24
}
}, labels.map((l, i) => React.createElement("span", {
key: i,
...
num: "// 04"
}, "So l\xE4uft die Werkstatt ab"), React.createElement("h2", {
style: {
fontSize: "clamp(30px,4.2vw,52px)",
marginBottom: 22,
textWrap: "balance"
}
}, "10 Minuten. Ein klarer Befund. Kein Pitch."), React.createElement("p", {
className: "lead",
style: {
color: "var(--ink-dim)",
fontSize: 16,
...
name: "arrow",
size: 16
})))), React.createElement("div", null, React.createElement(StepRow, {
num: "1",
icon: "cal",
title: "Slot sichern",
...
name: "cone",
size: 16
}), " Begrenzte Pl\xE4tze \xB7 Stand 14"), React.createElement(Eyebrow, {
num: "// 05"
}, "Werkstatt-Slot buchen"), React.createElement("h2", {
style: {
fontSize: "clamp(32px,4.6vw,60px)",
marginBottom: 20,
textWrap: "balance"
}
}, "Sichern Sie sich Ihre ", React.createElement("span", {
style: {
color: "var(--accent)"
}
}, "10 Minuten"), "."), React.createElement("p", {
className: "lead",
style: {
color: "var(--ink-dim)",
fontSize: 17,
...
}, "Die Pl\xE4tze an Stand 14 sind begrenzt. W\xE4hlen Sie einen Slot \u2014 wir bereiten Ihren Check vor."), React.createElement("ul", {
style: {
listStyle: "none",
padding: 0,
margin: 0,
...
}, [["clock", "Nur 10 Minuten Ihrer Messezeit"], ["target", "An Ihrem echten Webauftritt & Profil"], ["check", "Konkreter Befund statt Verkaufsgespräch"]].map(([ic, tx]) => React.createElement("li", {
key: tx,
style: {
display: "flex",
gap: 14,
...
name: ic,
size: 18
})), tx)))), React.createElement(Reveal, {
delay: 120
}, React.createElement(BookingEmbed, {
...
i === 2 && h("img", { src: "assets/hero-glass-sm.webp", alt: "", "aria-hidden": "true", loading: "lazy", width: 240, height: 240, style: { position: "absolute", right: -62, top: "50%", width: 104, transform: "translateY(-50%) rotate(-9deg)", filter: "drop-shadow(0 16px 26px rgba(219,10,48,.30))", pointerEvents: "none" } })))),
...
__blobifyScrubVideo(wrap, video);
let dur = 5.79;
...
const CHAPTERS = [
{ img: "assets/leistungen/audit.webp", alt: "KI-Audit: Diagnose-Scan für B2B-Marketing – Leistung der KI Marketing Agentur team::mt", num: "// 01", eyebrow: "KI-Audit", visual: AuditVisual,
...
{ img: "assets/leistungen/geo.webp", alt: "GEO-Check: Sichtbarkeit in KI-Suchen prüfen – KI Marketing Agentur team::mt", num: "// 02", eyebrow: "GEO-Check", visual: GeoVisual,
...
{ img: "assets/leistungen/linkedin.webp", alt: "LinkedIn-Check für den B2B-Auftritt – KI Marketing Agentur team::mt", num: "// 03", eyebrow: "LinkedIn-Check", visual: LinkedInVisual,
...
{ img: "assets/leistungen/landingpage.webp", alt: "KI-Landingpages in 5 Tagen live – KI Marketing Agentur für B2B", num: "// 04", eyebrow: "KI-Landingpages", visual: LandingVisual,
...
{ img: "assets/leistungen/social.webp", alt: "Social-Media-Automatisierung: vom Impuls zum fertigen Post – KI Marketing Agentur team::mt", num: "// 05", eyebrow: "Social-Media-Automatisierung", visual: SocialVisual,
...
h("img", { "data-inflow": "true", src: d.img, alt: d.alt || d.eyebrow, loading: "lazy", width: 1000, height: 1000, className: "prozess-float", style: { width: "clamp(66px,6.5vw,90px)", height: "auto", display: "block", marginBottom: 14, filter: "drop-shadow(0 12px 26px color-mix(in srgb,var(--accent) 40%, transparent))" } }),
...
if (r === "ok") { setDone(true); refreshAvail(); if (window.beyondTrack) window.beyondTrack("Beyond_Booking_Erfolg", { booking_date: selDate, booking_time: selTime }); }
...
else { setTaken(m => ({ ...m, [k]: (m[k] || 0) + 1 })); setDone(true); if (window.beyondTrack) window.beyondTrack("Beyond_Booking_Erfolg", { booking_date: selDate, booking_time: selTime }); }
}
...
h("img", { src: "assets/logo-wordmark.jpg", alt: "team::mt – KI Marketing Agentur, Rosenheim & Köln", width: 462, height: 76, style: { height: 26, width: "auto", display: "block", mixBlendMode: "multiply" } }),
...
{ n: "Katja Limbrunner", r: "Stellv. Gesch\u00e4ftsf\u00fchrung", li: "https://www.linkedin.com/in/katja-thomas/", img: "assets/team/katja.webp" },
...
{ n: "Joelle Lenz", r: "Marketing Managerin", li: "https://www.linkedin.com/in/joelle-lenz-38b963183/", img: "assets/team/joelle.webp" },
...
{ n: "Marcel Richtfeld", r: "Video Creator", img: "assets/team/marcel.webp" }
];
const TEAM_VALUES = [
...
m.img ? h("img", { src: m.img, alt: m.n + " – " + m.r + " bei team::mt, KI Marketing Agentur", loading: "lazy", style: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 16%" } }) : h(React.Fragment, null,
...
h("img", { src: "assets/team/group.avif", alt: "Team der KI Marketing Agentur team::mt – 33 Jahre B2B-Erfahrung in Rosenheim & Köln", loading: "lazy", style: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" } }),
...
return React.createElement(React.Fragment, null, h(HeroBootReveal, null), React.createElement(TopBar, {
onBook: goBook,
route: route
...
onBook: goBook
}), React.createElement(GlobalScanCursor, null), React.createElement(TweaksPanel, null, React.createElement(TweakSection, {
label: "Farben"
