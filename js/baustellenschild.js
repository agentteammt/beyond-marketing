...
}, "Achtung \u2013 ", React.createElement("span", {
className: "hl"
}, name), " wird gerade KI-tauglich gemacht"), React.createElement("div", {
className: "schild-sub"
}, SCHILD.subline)), generating && React.createElement("span", {
...
name: "sign",
size: 15
}), " Baustellenschild-Generator"), !intro && React.createElement(Eyebrow, {
num: "// 06"
}, "Ihr pers\xF6nliches Warnschild"), React.createElement("h2", {
style: {
fontSize: intro ? "clamp(24px,3.4vw,38px)" : "clamp(30px,4.2vw,52px)",
marginBottom: 16,
textWrap: "balance"
}
}, "Machen Sie Ihre Marke ", React.createElement("span", {
style: {
color: "var(--accent)"
}
}, "KI-tauglich"), "."), React.createElement("p", {
style: {
color: "var(--ink-dim)",
fontSize: 16,
marginBottom: 24,
...
}, "Firmennamen eingeben \u2014 Ihr Baustellenschild entsteht live. Zum Mitnehmen und Teilen."), React.createElement("label", {
htmlFor: uid + "-firma",
style: {
display: "block",
fontFamily: "Poppins",
...
}, "Ihr Unternehmen"), React.createElement("input", {
id: uid + "-firma",
value: firma,
...
onClick: download
}, "Schild herunterladen ", React.createElement(Icon, {
name: "arrow",
size: 16
})), React.createElement("button", {
className: "btn btn-ghost",
onClick: share
}, "Teilen")), shareMsg && React.createElement("div", {
style: {
marginTop: 12,
fontFamily: "Poppins",
fontSize: 13,
...
}, shareMsg), !intro && React.createElement("div", {
style: {
marginTop: 28,
paddingTop: 22,
borderTop: "1px solid var(--line)"
}
}, !sent ? React.createElement(React.Fragment, null, React.createElement("div", {
style: {
display: "flex",
gap: 10,
flexWrap: "wrap",
...
onClick: sendMail
}, "Schild + Slot zuschicken")), React.createElement("label", {
style: {
display: "flex",
gap: 9,
...
}), React.createElement("span", null, "Freiwillig: Ja, schickt mir mein Schild und Infos zum Werkstatt-Slot. Jederzeit widerrufbar \u2014 keine Weitergabe an Dritte."))) : React.createElement("div", {
style: {
display: "flex",
alignItems: "center",
gap: 10,
...
size: 18,
stroke: 2.4
}), " Notiert \u2014 wir melden uns. (Demo: es werden keine Daten gesendet.)"))), React.createElement("div", {
style: {
display: "flex",
justifyContent: "center"
}
}, React.createElement(SchildPreview, {
firma: firma,
