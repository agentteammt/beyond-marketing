/* AUTO-GENERIERT aus sections.jsx — NICHT direkt bearbeiten (Quelle: sections.jsx, dann neu kompilieren). */
;(function(){
...
function Icon({
  ...
  const P = {
    ...
    linkedin: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("rect", {
      x: "3",
      y: "3",
      width: "18",
      height: "18",
    ...
    video: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("rect", {
      x: "3",
      y: "6",
      width: "13",
      height: "12",
    ...
    drag: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
    ...
    cone: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
      d: "M5 20h14"
    }), /*#__PURE__*/React.createElement("path", {
    ...
    sign: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
      d: "M12 3.5 21.5 20H2.5L12 3.5Z"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M12 9.5v4.2M12 16.8v.2"
    })),
    helmet: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
      d: "M3.5 18h17"
    }), /*#__PURE__*/React.createElement("path", {
...
function Eyebrow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, children), num && /*#__PURE__*/React.createElement("span", {
...
function CapabilityCard({
  ...
  }, "Live-Check"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 50,
      height: 50,
      borderRadius: 2,
  ...
  }, body), tag && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      fontFamily: "Poppins",
      fontSize: 12,
...
function CheckBlock({
  ...
  }), [["top:14px;left:14px", "border-top:1px solid var(--accent);border-left:1px solid var(--accent)"], ["top:14px;right:14px", "border-top:1px solid var(--accent);border-right:1px solid var(--accent)"], ["bottom:14px;left:14px", "border-bottom:1px solid var(--accent);border-left:1px solid var(--accent)"], ["bottom:14px;right:14px", "border-bottom:1px solid var(--accent);border-right:1px solid var(--accent)"]].map((c, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    "aria-hidden": "true",
...
function StepRow({
  ...
  }, num), !last && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      width: 1,
      marginTop: 8,
...
function ScanBar({
  ...
  }, [0, 0.2, 0.4].map((d, i) => /*#__PURE__*/React.createElement("i", {
    key: i,
    className: "proc-dot",
    style: {
      width: 4,
...
function BigScan({
  ...
  }))), "Analysiert")), /*#__PURE__*/React.createElement("div", {
...
function FlagshipCheckCard({
  ...
  }), corners.map((c, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    "aria-hidden": "true",
    style: cornerStyle(c[0], c[1])
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, body), /*#__PURE__*/React.createElement(ScanBar, {
    label: scanLabel
  })));
}
function DemoCard({
...
function GlobalScanCursor({
  ...
  useEffect(() => {
    ...
    const SEL = "a[href], button:not([disabled]), .btn";
    let raf = 0,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "lock-lbl"
  }, "Ziel erfasst")), /*#__PURE__*/React.createElement("div", {
...
function QuickBook({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Werkstatt ge\xF6ffnet \xB7 ", event.dateShort, " \xB7 ", event.booth), /*#__PURE__*/React.createElement("div", {
    className: "display",
    style: {
      fontSize: "clamp(18px,2.4vw,24px)",
      marginTop: 4
    }
  }, "In 10 Minuten zum KI-Befund."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 10,
    ...
    className: "qb-hide"
  }, "Freie Slots"), chips.map(c => /*#__PURE__*/React.createElement("button", {
    key: c,
    onClick: onBook,
    style: {
      padding: "9px 14px",
...
function Marquee({
  ...
  }, "\u25C6")))), /*#__PURE__*/React.createElement("style", null, `@keyframes kiwmarq{to{transform:translateX(-50%)}}@media (prefers-reduced-motion: reduce){[style*="kiwmarq"]{animation:none!important}}`));
}
...
function BookingEmbed({
  ...
  return /*#__PURE__*/React.createElement(MockBooking, {
    booking: booking,
    event: event,
...
function MockBooking({
  ...
  async function submit() {
    ...
    try {
      ...
      if (result === "ok") {
        try {
          await refresh();
        } catch (e) {} // Verfügbarkeit (Punkte) nach Buchung live aktualisieren
        onBookClick && onBookClick();
        setDone(true);
      } else if (result === "full") {
  ...
  if (done) {
    ...
    }, "Slot gebucht"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: "var(--ink-dim)",
        maxWidth: 360,
        margin: "0 auto",
    ...
    }, cfg.dateLabel, ", ", slotById(selected) && slotById(selected).label || "", " Uhr \u2014 wir best\xE4tigen Ihren Werkstatt-Slot per E-Mail. Bis bald an ", event && event.booth || "Stand 14", "."), /*#__PURE__*/React.createElement("button", {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Werkstatt-Slot \xB7 ", cfg.dateLabel)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "Poppins",
      fontSize: 11.5,
      letterSpacing: ".18em",
  ...
  }, cfg.slotMinutes, " Min \xB7 ", event && event.booth || "Stand 14")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "22px"
    }
    ...
    className: "live-dot"
  }), " Verf\xFCgbarkeit wird geladen \u2026") : /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 18
    }
  ...
  }, "Aktuell sind keine Slots verf\xFCgbar."), groups.map((b, bi) => /*#__PURE__*/React.createElement("div", {
    key: bi,
    style: {
  ...
  }, b.label, " \xB7 ", b.items[0].label, "\u2013", b.items[b.items.length - 1].label), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    }, it.label), full ? /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9.5,
        letterSpacing: ".12em",
        textTransform: "uppercase",
    ...
    }, "voll") : /*#__PURE__*/React.createElement(CapDots, {
    ...
    onClick: submit
  }, submitting ? "Wird gebucht …" : /*#__PURE__*/React.createElement(React.Fragment, null, "Slot sichern ", /*#__PURE__*/React.createElement(Icon, {
    name: "arrow",
    size: 16
  ...
  }, live ? /*#__PURE__*/React.createElement(React.Fragment, null, "Jeder Slot ist ", cap, "\xD7 verf\xFCgbar \xB7 Echtzeit-Buchung \xFCber Supabase") : /*#__PURE__*/React.createElement(React.Fragment, null, "Demo-Modus \xB7 Supabase-Zugang in ", /*#__PURE__*/React.createElement("code", {
    style: {
      color: "var(--accent)"
    }
  }, "window.KIW_SUPABASE"), " (index.html) eintragen")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      paddingTop: 16,
      borderTop: "1px solid var(--line)",
  ...
  }, "Ihr Werkstatt-Slot auf dem"), /*#__PURE__*/React.createElement("img", {
...
function EventFooter({
  ...
  return /*#__PURE__*/React.createElement("footer", {
  ...
  }, "KI-Werkstatt"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--muted)",
      fontSize: 14,
      maxWidth: 300,
  ...
  }, "Quick-Check f\xFCr 360\xB0 KI-Marketing. Wir untersuchen Ihr Unternehmen auf KI-Tauglichkeit \u2014 direkt am Stand.")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: fHead
  }, "Event"), /*#__PURE__*/React.createElement(FRow, {
    icon: "cal",
    main: event.dateLong,
    sub: event.eventName
    ...
    style: fHead
  }, "Werkstatt-Slot"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--ink-dim)",
      fontSize: 14,
      marginTop: 0
    }
  }, "10 Minuten. Konkretes Ergebnis. Kein Verkaufsgespr\xE4ch."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-cta",
    onClick: onBookClick
  }, "Slot sichern ", /*#__PURE__*/React.createElement(Icon, {
    name: "arrow",
    size: 16
  })))), /*#__PURE__*/React.createElement(NeonDivider, null), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between",
      flexWrap: "wrap",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\xA9 2026 KI-Werkstatt \xB7 ", event.eventName), /*#__PURE__*/React.createElement("span", null, event.dateLong, " \xB7 ", event.place, " \xB7 ", event.booth))));
}
function FRow({
  icon,
  main,
